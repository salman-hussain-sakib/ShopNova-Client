...
export default function RegisterPage() {
  const { register, googleLogin, facebookLogin, user } = useAuth();
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="card w-full max-w-md p-8">
        <h1 className="text-2xl font-bold text-neutral-dark mb-2">Create Account</h1>
        <p className="text-neutral text-sm mb-6">Join ShopNova for personalized shopping</p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm font-medium text-neutral-dark mb-1 block">Full Name</label>
            <input
              type="text"
              value={form.name}
          ...
          <div>
            <label className="text-sm font-medium text-neutral-dark mb-1 block">Email</label>
            <input
              type="email"
              value={form.email}
          ...
          <div>
            <label className="text-sm font-medium text-neutral-dark mb-1 block">Phone (optional)</label>
            <input
              type="tel"
              value={form.phone}
          ...
          <div>
            <label className="text-sm font-medium text-neutral-dark mb-1 block">Confirm Password</label>
            <div className="relative">
              <input
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white dark:bg-[#0f172a] px-3 py-0.5 text-[10px] font-semibold text-neutral/70 uppercase tracking-wider rounded-full border border-neutral/10">Or sign up with</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 py-1">
          ...
          <FacebookLoginButton
            ...
            onError={() => setError('Facebook sign-up failed')}
            variant="icon"
          />
        </div>
